...
class Developer extends Employee {
  constructor(
    ...
    surname: string,
    experienceYears: number,
    public programmingLanguage: keyof typeof LANGUAGES,
  ) {
    super(name, surname, experienceYears);
  }
...
const manager = new Manager('John', 'Doe', 2, 'kanban');
console.log(manager);
console.log(manager.getDetails());

const developer = new Developer('Jane', 'Doe', 5, 'js');
